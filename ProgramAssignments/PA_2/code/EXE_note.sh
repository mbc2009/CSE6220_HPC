...
Vendor ID:                GenuineIntel
  Model name:             Intel(R) Xeon(R) Gold 6226 CPU @ 2.70GHz
    ...
    Flags:                fpu vme de pse tsc msr pae mce cx8 apic sep mtrr pge mca cmov pat pse36 clflush dts acpi mmx fxsr s
                          ...
                          vx f16c rdrand lahf_lm abm 3dnowprefetch cpuid_fault epb cat_l3 cdp_l3 intel_ppin ssbd mba ibrs ibp
                          b stibp ibrs_enhanced tpr_shadow flexpriority ept vpid ept_ad fsgsbase tsc_adjust bmi1 avx2 smep bm
                          i2 erms invpcid cqm mpx rdt_a avx512f avx512dq rdseed adx smap clflushopt clwb intel_pt avx512cd av
                          x512bw avx512vl xsaveopt xsavec xgetbv1 xsaves cqm_llc cqm_occup_llc cqm_mbm_total cqm_mbm_local dt
                          herm ida arat pln pts hwp hwp_act_window hwp_epp hwp_pkg_req vnmi pku ospke avx512_vnni md_clear fl
...
##AllReduce 15
Time taken by custom function: 12.799090
AllReduce P=15 Correctness passed!
 
##AllReduce 24
Time taken by custom function: 22.090597
diff: autograderout/myoutputard_24.txt: No such file or directory
AllReduce P=24 Failed
...
Time taken by custom function: 11.537822
Correct Output
 
##Many2Many 24
size_in_file: 24, size: 24
Time taken by custom function: 31.830252
Correct Output
==================== RUNTIME TESTS =====================
 
##AllReduce
Custom function time: 22.023899
Runtime test passed!
Runtime test passed!
...
##Many2Many
Custom function time: 31.805438
Runtime test passed!
Runtime test passed!
(base) [hliu686@atl1-1-02-002-23-1 code]$ 